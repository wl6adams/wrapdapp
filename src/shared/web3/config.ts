...
import { MARKET_ADDRESSES_TYPE, Networks, SupportedChainId, TOKEN_SYMBOLS_TYPE } from './types';
...
export const BULKER_ADDRESS: Record<SupportedChainId, { [key: string]: Address }> = {
  [mainnet.id]: {
