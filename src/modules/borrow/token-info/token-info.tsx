...
const TokenInfo = () => {
  ...
  const tokenInfo = [
    {
      tooltipText: 'Amount of assets borrowed in this market',
      title: 'Total Borrowed',
      value: selectedMarketData ? `$${formatNumber(selectedMarketData.totalBorrowed)}` : '$32.14M',
    },
    {
  ...
  return (
    <Grid
      ...
      gridTemplateColumns={{ base: 'repeat(2, 1fr)', laptop: 'repeat(5, 1fr)' }}
    >
      <Each
        data={tokenInfo}
        render={(el, index) => (
